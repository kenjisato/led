...
$P$ は固有ベクトルを並べた行列である。式\@ref(eq:J-matrix)より，
$$
\begin{aligned}
  AP 
  &= P \left(
...
$1/(\beta \bar \lambda)$も固有値である。1つの複素固有値から3つの複素固有値が派生する。図\@ref(fig:remasey-multsector-saddle), 図\@ref(fig:ramsey-multsector-unstable)。
