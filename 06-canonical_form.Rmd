...
この節は \citet{Lewis1984}, \citet{Lewis1986}, \citet{Katayama1999}
および \citet{Berger2012} を参考にした. 付録 B で \citet{Berger2012} に基づく証明を述べる. 
...
$u_{t}$ によって解軌道が一意的に定まる. これは \citet{Luenberger1977} の結果である. 
\begin{problem}
...
\citet{Berger2012} (以下, {[}BIT{]})の議論に沿ってワイエルシュトラス標準形を導出しよう. 

以下で定義する部分空間列は, \citet{Wong1974} で導入された. 極限空間がデスクリプタシステムの分析に重要な役割を果たすことが知られている.
{[}\citet{Lewis1984}{]} 
